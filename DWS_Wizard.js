...
function init()
{
  ...
  WIZARD_QUESTIONS["dws_edit_primic_4"] = { feedbackId: "dws_setup_primic_4", text: "Enter the Serial Number of the Microphone:", inputType: "SingleLine", keyboardState: "Open", placeholder: "Ex. FOC28xxxxxx"},
  ...
  xapi.Event.UserInterface.Extensions.Widget.Action.on(event => {
    ...
    else if( event.Type == 'released' && event.WidgetId == 'dws_setup_begin' )
    {
      ...
      else if(SETUP_VARIABLES['dws_setup_primic_1'] == undefined)
      {
        xapi.Command.UserInterface.Message.Alert.Display({ Duration: '5', Title:"Missing Variables", Text: "Please configure at least one Primary Microphone Serial Number."});
        xapi.Command.UserInterface.Extensions.Panel.Open( { PageId: 'setup_primary_mics', PanelId: 'dws_wizard' });
        console.log("DWS: Missing Variables. Prompting User to enter required details.");
      }
      ...
      .then ((productPlatform) => {
        ...
        if (SETUP_VARIABLES['dws_setup_primic_4'] != null)
        {
          COMBINED_PRI_MICS.push(SETUP_VARIABLES['dws_setup_primic_4'])
        }
