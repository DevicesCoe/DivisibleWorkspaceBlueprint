      ...
      switch(event.WidgetId)
      {
        ...
        case "dws_mics_audience": // LISTEN FOR CHANGE ON AUDIENCE MICS TOGGLE
          if (event.Value == 'on')
          {
            ...
            {
              xapi.Config.Audio.Input.Ethernet[1].Channel[1].Level.set(DWS_ADV_AUD);
              xapi.Config.Audio.Input.Ethernet[1].Channel[2].Level.set(DWS_ADV_AUD);
              xapi.Config.Audio.Input.Ethernet[1].Channel[3].Level.set(DWS_ADV_AUD);
              xapi.Config.Audio.Input.Ethernet[1].Channel[4].Level.set(DWS_ADV_AUD);
            }
            else if (DWS.PLATFORM == 'Codec EQ' || DWS.PLATFORM == 'Room Bar Pro')
            {
              xapi.Config.Audio.Input.Ethernet[1].Channel[1].Gain.set(DWS_ADV_AUD);
              xapi.Config.Audio.Input.Ethernet[1].Channel[2].Gain.set(DWS_ADV_AUD);
              xapi.Config.Audio.Input.Ethernet[1].Channel[3].Gain.set(DWS_ADV_AUD);
              xapi.Config.Audio.Input.Ethernet[1].Channel[4].Gain.set(DWS_ADV_AUD);
            }
          ...
          if (event.Value == 'off')
          {
            ...
            if (DWS.PLATFORM == 'Codec Pro')
            {
              ...
              xapi.Config.Audio.Input.Ethernet[1].Channel[2].Level.set(0);
              xapi.Config.Audio.Input.Ethernet[1].Channel[3].Level.set(0);
              xapi.Config.Audio.Input.Ethernet[1].Channel[4].Level.set(0);
            }
            else if (DWS.PLATFORM == 'Codec EQ' || DWS.PLATFORM == 'Room Bar Pro')
            {
              xapi.Config.Audio.Input.Ethernet[1].Channel[1].Gain.set(0);
              xapi.Config.Audio.Input.Ethernet[1].Channel[2].Gain.set(0);
              xapi.Config.Audio.Input.Ethernet[1].Channel[3].Gain.set(0);
              xapi.Config.Audio.Input.Ethernet[1].Channel[4].Gain.set(0);
            }
          }
          break;
        ...
        case "dws_edit_level_audience": // LISTEN FOR CHANGE IN GAIN/LEVEL ON AUDIENCE MICS
          if (event.Value == 'increment'){
            ...
            if (DWS.PLATFORM == 'Codec Pro')
            {
              ...
              xapi.Config.Audio.Input.Ethernet[1].Channel[2].Level.set(newlevel);
              xapi.Config.Audio.Input.Ethernet[1].Channel[3].Level.set(newlevel);
              xapi.Config.Audio.Input.Ethernet[1].Channel[4].Level.set(newlevel);
            }
            else if (DWS.PLATFORM == 'Codec EQ' || DWS.PLATFORM == 'Room Bar Pro')
            {
              xapi.Config.Audio.Input.Ethernet[1].Channel[1].Gain.set(newlevel);
              xapi.Config.Audio.Input.Ethernet[1].Channel[2].Gain.set(newlevel);
              xapi.Config.Audio.Input.Ethernet[1].Channel[3].Gain.set(newlevel);
              xapi.Config.Audio.Input.Ethernet[1].Channel[4].Gain.set(newlevel);
            }               
...
xapi.Event.UserInterface.Message.Prompt.Response.on(value => {
  ...
  else if (value.FeedbackId != 'confirmCombine' && value.FeedbackId != 'confirmSplit')
  {
