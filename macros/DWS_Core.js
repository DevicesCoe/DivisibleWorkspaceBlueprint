...
function init() {
  ...
  // DRAW ADVANCED HIDDEN PANEL
  xapi.Command.UserInterface.Extensions.Panel.Save({ PanelId: 'dws_advanced' }, PANEL_ADVANCED)
  .then (() =>  {

    // SET DEFAULTS FOR AUDIENCE MIC LEVELS
    xapi.Config.Audio.Input.Ethernet[1].Channel[1].Level.get()
    .then (response => {
      if(response == '0')
      {
      ...
      xapi.Command.UserInterface.Extensions.Widget.SetValue({ Value: response, WidgetId: 'dws_edit_level_audience' });
    })

    // SET DEFAULTS FOR PRESENTER MIC LEVELS
    xapi.Config.Audio.Input.USBInterface[1].Level.get()
    .then (response => {
      if(response == '0')
      {
        // SET THE MIC TO "DISABLED"
      ...
      xapi.Command.UserInterface.Extensions.Widget.SetValue({ Value: response, WidgetId: 'dws_edit_level_presenter' });
    })
        ...
        case 'dws_unlock': // LISTEN FOR ADVANCED PANEL UNLOCK  
          ...
          .then(() => {
            ...
            .on(event => {
              ...
              {
                if (DWS.DEBUG == 'true') {console.error("DWS: Entered PIN did not match configured PIN.")};
              }              
            })
          })
          break;
        case "dws_mics_audience":
          if (event.Value == 'on')
          {
            // GET "SAVED" LEVEL FROM PANEL AND RESET LEVEL TO MATCH
            xapi.Status.UserInterface.Extensions.Widget['39'].get()
            .then(response => {
              xapi.Config.Audio.Input.Ethernet[1].Channel[1].Level.set(response.Value); 
              if (DWS.DEBUG == 'true') {console.debug("DWS: (Advanced) Audience mic enabled. Setting level to: " + response.Value)};
            })
          ...
          if (event.Value == 'off')
          {
            ...
            xapi.Config.Audio.Input.Ethernet[1].Channel[1].Level.set(0)
            .catch (error => { console.log(error)})
          }
          break;
        case "dws_edit_level_audience": // LISTEN FOR CHANGE IN GAIN/LEVEL ON AUDIENCE MICS
          if (event.Value == 'increment'){
            ...
            .then(response => {
              ...
              if (response != 70)
              {
                newlevel = parseInt(response) + 1;
                xapi.Command.UserInterface.Extensions.Widget.SetValue({ Value: 'on', WidgetId: 'dws_mics_audience' });
              }
              else{
                newlevel = response;
              }
              xapi.Config.Audio.Input.Ethernet[1].Channel[1].Level.set(newlevel);              
          ...
          break;
        case "dws_mics_presenter":
          if (event.Value == 'on')
          {
            // GET "SAVED" LEVEL FROM PANEL AND RESET LEVEL TO MATCH
            xapi.Status.UserInterface.Extensions.Widget['38'].get()
            .then(response => {
              xapi.Config.Audio.Input.USBInterface[1].Level.set(response.Value); 
              if (DWS.DEBUG == 'true') {console.debug("DWS: (Advanced) Presenter mic enabled. Setting level to: " + response.Value)};
            })
            .catch (error => { console.log(error)})
          }
          if (event.Value == 'off')
          {
            if (DWS.DEBUG == 'true') {console.debug("DWS: (Advanced) Presenter mic disabled. Setting level to: 0")};
            xapi.Config.Audio.Input.USBInterface[1].Level.set(0)
            .catch (error => { console.log(error)})
          }
          break;
        case "dws_edit_level_presenter": // LISTEN FOR CHANGE IN GAIN/LEVEL ON PRESENTER USB MICS
          if (event.Value == 'increment'){
            ...
            .then(response => {
              ...
              if (DWS.DEBUG == 'true') {console.debug("DWS: (Advanced) Presenter mic gain/level incremented to: " + newlevel)};
            })            
          }
          else if (event.Value == 'decrement') {
            //ADJUST GAIN ON ALL PRESENTER USB MICS
            ...
            .then(response => {
              ...
              xapi.Config.Audio.Input.USBInterface[1].Level.set(newlevel);
              xapi.Command.UserInterface.Extensions.Widget.SetValue({ Value: newlevel, WidgetId: 'dws_edit_level_presenter' });
              if (DWS.DEBUG == 'true') {console.debug("DWS: (Advanced) Presenter mic gain/level decremented to: " + newlevel)};              
            })
          }          
          break;
      }
...
// ADVANCED PANEL
const PANEL_ADVANCED = `<Extensions><Version>1.11</Version><Panel><Order>1</Order><PanelId>dws_advanced</PanelId><Origin>local</Origin><Location>HomeScreen</Location><Icon>Sliders</Icon><Name>Advanced Controls</Name><ActivityType>Custom</ActivityType><Page><Name>Microphone Settings</Name><Row><Name>Audience Microphones</Name><Widget><WidgetId>widget_51</WidgetId><Name>Primary Audience</Name><Type>Text</Type><Options>size=1;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_mics_audience</WidgetId><Type>ToggleButton</Type><Options>size=1</Options></Widget><Widget><WidgetId>widget_120</WidgetId><Name>Secondary Audience</Name><Type>Text</Type><Options>size=1;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_mics_audience_sec</WidgetId><Type>ToggleButton</Type><Options>size=1</Options></Widget><Widget><WidgetId>dws_edit_level_audience</WidgetId><Type>Spinner</Type><Options>size=2;style=plusminus</Options></Widget><Widget><WidgetId>dws_edit_level_audience_sec</WidgetId><Type>Spinner</Type><Options>size=2;style=plusminus</Options></Widget><Widget><WidgetId>widget_65</WidgetId><Name>Use these controls to raise or lower the level/gain on the microphones. Default values: Audience (45), Presenter USB (5), Presenter Analog (45).</Name><Type>Text</Type><Options>size=4;fontSize=small;align=center</Options></Widget></Row><Row><Name>Presenter Microphones</Name><Widget><WidgetId>widget_53</WidgetId><Name>Presenter USB</Name><Type>Text</Type><Options>size=1;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_mics_presenter</WidgetId><Type>ToggleButton</Type><Options>size=1</Options></Widget><Widget><WidgetId>widget_117</WidgetId><Name>Presenter Analog</Name><Type>Text</Type><Options>size=1;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_mics_presenter_analog</WidgetId><Type>ToggleButton</Type><Options>size=1</Options></Widget><Widget><WidgetId>dws_edit_level_presenter</WidgetId><Type>Spinner</Type><Options>size=2;style=plusminus</Options></Widget><Widget><WidgetId>dws_edit_level_presenter_analog</WidgetId><Type>Spinner</Type><Options>size=2;style=plusminus</Options></Widget></Row><Options/></Page><Page><Name>Primary Mics</Name><Row><Name>Primary Room Microphones</Name><Widget><WidgetId>dws_setup_primic_1</WidgetId><Name>${DWS.PRIMARY_MICS[0]}</Name><Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_primic_1</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget><Widget><WidgetId>dws_setup_primic_2</WidgetId><Name>${DWS.PRIMARY_MICS[1]}</Name><Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_primic_2</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget><Widget><WidgetId>dws_setup_primic_3</WidgetId><Name>${DWS.PRIMARY_MICS[2]}</Name><Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_primic_3</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget><Widget><WidgetId>dws_setup_primic_4</WidgetId><Name>${DWS.PRIMARY_MICS[3]}</Name><Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_primic_4</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget></Row><Row><Name/><Widget><WidgetId>widget_112</WidgetId><Name>You can modify the Serial Numbers of the Primary Microphones above. Click "Update" when you are finished.</Name><Type>Text</Type><Options>size=4;fontSize=small;align=center</Options></Widget></Row><Row><Name/><Widget><WidgetId>adv_pri_mics</WidgetId><Name>Update</Name><Type>Button</Type><Options>size=2</Options></Widget></Row><Options/></Page><Page><Name>Secondary Mics</Name><Row><Name>Secondary Room Microphones</Name><Widget><WidgetId>dws_setup_secmic_1</WidgetId><Name>${DWS.SECONDARY_MICS[0]}</Name><Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_secmic_1</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget><Widget><WidgetId>dws_setup_secmic_2</WidgetId>${DWS.SECONDARY_MICS[1]}<Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_secmic_2</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget><Widget><WidgetId>dws_setup_secmic_3</WidgetId>${DWS.SECONDARY_MICS[2]}<Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_secmic_3</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget><Widget><WidgetId>dws_setup_secmic_4</WidgetId>${DWS.SECONDARY_MICS[3]}<Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_secmic_4</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget></Row><Row><Name/><Widget><WidgetId>widget_114</WidgetId><Name>You can modify the Serial Numbers of the Secondary Microphones above. Click "Update" when you are finished.</Name><Type>Text</Type><Options>size=4;fontSize=small;align=center</Options></Widget></Row><Row><Name/><Widget><WidgetId>adv_sec_mics</WidgetId><Name>Update</Name><Type>Button</Type><Options>size=2</Options></Widget></Row><Options/></Page><Page><Name>Secondary Navs</Name><Row><Name>Control Navigator</Name><Widget><WidgetId>dws_setup_sec_control</WidgetId><Name>${DWS.SECONDARY_NAV_CONTROL}</Name><Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_sec_control</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget></Row><Row><Name>Scheduler Navigator</Name><Widget><WidgetId>dws_setup_sec_scheduler</WidgetId><Name>${DWS.SECONDARY_NAV_SCHEDULER}</Name><Type>Text</Type><Options>size=3;fontSize=normal;align=center</Options></Widget><Widget><WidgetId>dws_edit_sec_scheduler</WidgetId><Name>Edit</Name><Type>Button</Type><Options>size=1</Options></Widget></Row><Row><Name/><Widget><WidgetId>widget_114</WidgetId><Name>You can modify the MAC Addresses of the Secondary Navigators above. Click "Update" when you are finished.</Name><Type>Text</Type><Options>size=4;fontSize=small;align=center</Options></Widget></Row><Row><Name/><Widget><WidgetId>adv_sec_navs</WidgetId><Name>Update</Name><Type>Button</Type><Options>size=2</Options></Widget></Row><Options/></Page></Panel></Extensions>`;
